...
categories: [LLMs, fine-tuning, axolotl, blogging]
author: Hamel Husain
date: 2024-01-11
...
![Debugging Axolotl in VSCode](images/debug_axolotl.png)
...
[^2]: Many of the below flags are recommended best practices by Nvidia when using nvidia-container-toolkit.  You can read more about these flags in the [NVIDIA Container Toolkit documentation](https://docs.nvidia.com/deeplearning/frameworks/user-guide/index.html).